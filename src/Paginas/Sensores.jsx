...
export function Sensores() {
  ...
  const sensores = [
    {
      id: 1,
      nome: "Sensor Exemplo1",
      tipo: "Temperatura",
      ambiente: "Exemplo1",
      status: "Ativo",
      ultimaLeitura: "23.5°C",
    },
    {
      id: 2,
      nome: "Sensor Exemplo2",
      tipo: "Umidade",
      ambiente: "Exemplo2",
      status: "Ativo",
      ultimaLeitura: "48%",
            ...
            <tbody>
              {sensores.map((sensor) => (
                <tr key={sensor.id}>
                  ...
                  <td>
                    <span
                      className={`${estilo.status} ${estilo[sensor.status.toLowerCase()]}`}
                    >
                      {sensor.status}
                    </span>
                  </td>
                  ...
                  <td>
                    <div className={estilo.acoes}>
                      ...
                      <button className={estilo.botaoExcluir}>Excluir</button>
                    </div>
                  </td>
                </tr>
              ))}
